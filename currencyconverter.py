...
Tops = Frame(root, bg='#5f6e78', pady=2, width=1850, height=100, relief="ridge")
...
def RealTimeCurrencyConversion():
    ...
    if (Amount1_field.get() == ""):
        ...
        tkinter.messagebox.showinfo('YOUR AMOUNT IS',new_amount)
...
label1.grid(row=2, column=0, sticky=W, pady=6)

label1 = tk.Label(root, font=('lato black', 15, 'bold'), text="\t    From Currency  :  ", bg="#e6e5e5", fg="black")
label1.grid(row=3, column=0, sticky=W,pady=10)
...
Label_9 = Button(root, font=('arial', 15, 'bold'), text="   Convert  ", padx=2, pady=2, bg="#00ffff", fg="gray",
...
Label_9 = Button(root, font=('arial', 15, 'bold'), text="   Clear All  ", padx=2, pady=2, bg="#00ffff", fg="gray",
                 command=clear_all)
